...
- **DR-002**: Any added dependency/component MUST include demo-critical justification
...
- **DR-005**: Provide `.env.example` with safe dummy values and define a reset path
