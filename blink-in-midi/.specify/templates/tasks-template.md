...
- [ ] T004 Create single setup-and-run command/script and document in quickstart.md
- [ ] T005 [P] Add `.env.example` with safe dummy values
- [ ] T006 Define smoke check command/script and demo reset path
- [ ] T007 Record demo-critical justification for each non-trivial dependency
...
Examples of foundational tasks (choose only what the demo actually needs):

- [ ] T008 Implement only the minimal shared model/state needed by all stories
- [ ] T009 [P] Add only essential error handling for demo reliability
- [ ] T010 [P] Add minimal runtime configuration loading
- [ ] T011 Validate architecture remains single-process/single-project
- [ ] T012 Remove or defer non-demo-critical infrastructure
...
- Re-check every task against Simplicity First before starting work
