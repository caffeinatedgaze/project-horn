...
- [ ] T004 Create demo setup command/script and document it in quickstart.md
- [ ] T005 [P] Add `.env.example` with safe dummy values
- [ ] T006 [P] Draft component contracts doc with example I/O
- [ ] T007 Define smoke check command/script and data reset path
